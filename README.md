...
# 🛒 Testy Manualne - Platforma E-commerce Skleptest.pl

## 📖 Opis Projektu
Projekt obejmuje kompleksowe testy funkcjonalne oraz UX platformy sprzedażowej **www.skleptest.pl**. Skupiłem się na weryfikacji pełnego cyklu zakupowego (End-to-End) – od wyszukiwania produktu, przez zarządzanie koszykiem, aż po finalizację zamówienia i walidację procesów płatniczych.
...
* **Analiza Przypadków Użycia** (User Stories Testing).
* **Testowanie Ścieżki Krytycznej** (Critical Path Testing).
